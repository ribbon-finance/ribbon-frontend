...
> {
        ...
        return {
            ...
            getABIEncodedTransactionData(): string {
                return self._strictEncodeArguments(functionSignature, [collateralAmount
            ]);
            },
        }
    };
...
> {
        ...
        return {
            ...
            getABIEncodedTransactionData(): string {
                return self._strictEncodeArguments(functionSignature, [collateral,
            dToken,
            maxSlippage
            ]);
            },
...
> {
    ...
    constructor(
        ...
        deployedBytecode: string | undefined = InstrumentInterfaceContract.deployedBytecode,
    ) {
        super('InstrumentInterface', InstrumentInterfaceContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
