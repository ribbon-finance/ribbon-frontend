...
export interface LiquidityGaugeControllerInterface extends utils.Interface {
  contractName: "LiquidityGaugeController";
  functions: {
...
export interface LiquidityGaugeController extends BaseContract {
  contractName: "LiquidityGaugeController";
  ...
  filters: {
    ...
    "VotingEnabled(bool)"(voting_enabled?: null): VotingEnabledEventFilter;
    VotingEnabled(voting_enabled?: null): VotingEnabledEventFilter;
