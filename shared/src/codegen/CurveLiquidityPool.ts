...
export interface CurveLiquidityPoolInterface extends utils.Interface {
  contractName: "CurveLiquidityPool";
  functions: {
    "A()": FunctionFragment;
...
export interface CurveLiquidityPool extends BaseContract {
  contractName: "CurveLiquidityPool";
