...
import type { IncentivizedVotingLockup } from "./IncentivizedVotingLockup";

export class IncentivizedVotingLockupFactory {
  static connect(
    address: string,
...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: true,
        internalType: "address",
        name: "delegateeToRemove",
        type: "address",
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "amtDelegationRemoved",
        type: "uint256",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "bool",
        name: "_contractStopped",
        type: "bool",
      },
    ],
    name: "setContractStopped",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
