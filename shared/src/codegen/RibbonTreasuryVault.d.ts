...
interface RibbonTreasuryVaultInterface extends ethers.utils.Interface {
  functions: {
    ...
    "chargeAndDistribute()": FunctionFragment;
    "commitAndClose()": FunctionFragment;
    "completeWithdraw()": FunctionFragment;
    "concludeOptionsSale()": FunctionFragment;
    ...
    "whitelistMap(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "chargeAndDistribute",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "concludeOptionsSale",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "CollectManagementFee(uint256,uint256,address)": EventFragment;
    "CollectPerformanceFee(uint256,uint256,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "CollectManagementFee"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "CollectPerformanceFee"): EventFragment;
...
export class RibbonTreasuryVault extends Contract {
  ...
  interface: RibbonTreasuryVaultInterface;
  ...
  functions: {
    ...
    chargeAndDistribute(overrides?: Overrides): Promise<ContractTransaction>;
    ...
    concludeOptionsSale(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  whitelistMap(arg0: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  callStatic: {
    ...
    chargeAndDistribute(overrides?: CallOverrides): Promise<void>;
    ...
    concludeOptionsSale(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    chargeAndDistribute(overrides?: Overrides): Promise<BigNumber>;
    ...
    concludeOptionsSale(overrides?: Overrides): Promise<BigNumber>;
    ...
    whitelistMap(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    chargeAndDistribute(overrides?: Overrides): Promise<PopulatedTransaction>;
    ...
    concludeOptionsSale(overrides?: Overrides): Promise<PopulatedTransaction>;
