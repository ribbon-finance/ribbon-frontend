...
import type { LidoOracle, LidoOracleInterface } from "../LidoOracle";
...
export class LidoOracle__factory {
  static readonly abi = _abi;
  static createInterface(): LidoOracleInterface {
    return new utils.Interface(_abi) as LidoOracleInterface;
  }
  static connect(
    address: string,
