...
import type {
  RibbonEarnVault,
  RibbonEarnVaultInterface,
} from "../RibbonEarnVault";
...
export class RibbonEarnVault__factory {
  static readonly abi = _abi;
  static createInterface(): RibbonEarnVaultInterface {
    return new utils.Interface(_abi) as RibbonEarnVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RibbonEarnVault {
    return new Contract(address, _abi, signerOrProvider) as RibbonEarnVault;
  }
}
