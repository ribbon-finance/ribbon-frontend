...
import type { RibbonTreasuryVault } from "./RibbonTreasuryVault";

export class RibbonTreasuryVaultFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RibbonTreasuryVault {
    return new Contract(address, _abi, signerOrProvider) as RibbonTreasuryVault;
  }
}
