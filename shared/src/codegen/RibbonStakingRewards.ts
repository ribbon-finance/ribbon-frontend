...
export interface RibbonStakingRewardsInterface extends utils.Interface {
  contractName: "RibbonStakingRewards";
  functions: {
...
export interface RibbonStakingRewards extends BaseContract {
  contractName: "RibbonStakingRewards";
