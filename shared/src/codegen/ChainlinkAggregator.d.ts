...
interface ChainlinkAggregatorInterface extends ethers.utils.Interface {
  functions: {
...
export class ChainlinkAggregator extends Contract {
  ...
  estimateGas: {
    ...
    transferOwnership(_to: string, overrides?: Overrides): Promise<BigNumber>;
