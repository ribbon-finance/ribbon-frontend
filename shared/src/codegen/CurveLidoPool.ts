...
export interface CurveLidoPoolInterface extends utils.Interface {
  contractName: "CurveLidoPool";
  functions: {
    "A()": FunctionFragment;
...
export interface CurveLidoPool extends BaseContract {
  contractName: "CurveLidoPool";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveLidoPoolInterface;
