...
export const PERPLogo: React.FC<SVGProps> = ({
  ...props
}) => (
  <svg
    viewBox="0 0 675 675"
    ...
    {...props}
  >
    <circle cx="337.5" cy="337.5" r="337.5" fill="#00BC9A" fill-opacity="0.16"/>
    <path fill-rule="evenodd" clip-rule="evenodd" d="M177.228 351.961C157.035 331.869 156.908 299.166 176.946 278.918L262.695 192.27C282.733 172.021 315.347 171.894 335.541 191.987L377.125 233.361L379.604 230.875C399.72 210.705 432.335 210.705 452.451 230.875L497.913 276.46C518.029 296.63 518.029 329.333 497.913 349.503L389.102 458.607L361.762 486.234C359.933 488.083 357.949 489.684 355.852 491.037C342.271 500.226 323.672 498.795 311.654 486.744L254.462 429.398C252.928 427.86 251.511 426.249 250.211 424.575L177.228 351.961ZM415.065 274.048L376.773 312.444L415.065 350.839L453.357 312.444L415.065 274.048ZM219.622 311.691L296.051 235.056L334.343 273.452L257.914 350.086L219.622 311.691ZM337.363 351.208L299.07 389.603L337.363 427.999L375.655 389.603L337.363 351.208Z" fill="#00BC9A"/>
  </svg>
);
