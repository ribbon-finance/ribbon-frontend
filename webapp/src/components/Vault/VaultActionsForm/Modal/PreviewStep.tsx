    ...
    case ACTIONS.migrate:
      return (
        ...
        >
          ...
          {/* Info Preview */}
          <div className="d-flex w-100 flex-row align-items-center justify-content-between mt-4 mt-md-auto">
          ...
          <div className="d-flex w-100 flex-row align-items-center justify-content-between mt-4 mb-4 mb-md-auto">
